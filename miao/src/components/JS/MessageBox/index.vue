...
<style scoped>
.zjhe{width: 100%;height: 100%;position: fixed; top: 0;z-index: 1003;}
    .messageBox{ width:200px; height:120px; border:1px #ccc solid; border-radius: 4px; background:white; box-shadow: 3px 3px 3px 3px #ccc; position: fixed; left: 50%; top: 50%; margin:-60px 0 0 -100px; z-index: 1001;}
